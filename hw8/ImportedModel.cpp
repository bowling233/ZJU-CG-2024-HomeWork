...
void ModelImporter::parseOBJ(const char *filePath) {
	...
	// print all length
	std::cout << "vertVals: " << vertVals.size() << std::endl;
	std::cout << "triangleVerts: " << triangleVerts.size() << std::endl;
	std::cout << "textureCoords: " << textureCoords.size() << std::endl;
	std::cout << "stVals: " << stVals.size() << std::endl;
	std::cout << "normals: " << normals.size() << std::endl;
	std::cout << "normVals: " << normVals.size() << std::endl;
}
