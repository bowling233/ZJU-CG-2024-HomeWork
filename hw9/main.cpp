...
GLuint earthTexture, carTexture, skyboxTexture;
...
ImportedModel carModel("Andy2.obj");
...
void setupVertices(void)
{
	...
	glBindBuffer(GL_ARRAY_BUFFER, vbo[2][0]);
...
void init(GLFWwindow *window)
{
	...
	carTexture = Utils::loadTexture("Andy.png");
	skyboxTexture = Utils::loadCubeMap("cubeMapzju");
...
void display(GLFWwindow *window, double currentTime)
{
	 ...
	 * car
	 */
	mMat = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, 3.0f));
